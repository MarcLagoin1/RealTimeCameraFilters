...
class App:
    def __init__(self):
        ...
        # Couleurs des boutons en fonction de l'état du filtre
        self.button_colors = {
            True: "green",  # Filtre activé
            False: "gray"   # Filtre désactivé
        }
    ...
    def _create_widgets(self):
        # Conteneur pour la ligne supérieure (vidéo + filtres)
        ...
        # Conteneur pour les boutons des filtres
        ...
        for index, filter_name in enumerate(self.filter_status.keys()):
            # Crée un nouveau conteneur pour chaque nouvelle colonne de filtres
            if index % 7 == 0:
                filters_frame = tk.Frame(top_frame)
                filters_frame.pack(side=tk.LEFT, padx=10)
        ...
        # Conteneur pour l'histogramme
        bottom_frame = tk.Frame(self.window)
        bottom_frame.pack(side=tk.TOP, pady=10)

        # Création de la figure et du subplot pour l'histogramme
